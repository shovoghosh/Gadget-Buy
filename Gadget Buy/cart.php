...
<div class="container padding-10">
	...
	<?php
		...
		foreach ($carts as $key => $cart) {
           ...
           <input name=quan, id=quan size=2 maxlength=2 type=number >
           {$quantity} availabe
            </td>
            ...
            <td><button class='refresh-from-cart btn btn-primary text-18' id='{$cart_id}'><i class='fa fa-refresh'></i></button></td>
			...
			<div class="modal-body">
        		<form action="cart.php" method="post" id="place_order_form">
        			...
        			<div class="form-group">
        				...
        				<input type="text" class="form-control order_input" name="order_mobile" id="order_mobile" placeholder="Enter your 11 digit mobile number">
        			</div>
        			<div class="form-group">
